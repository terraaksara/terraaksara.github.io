                        ...
                        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                ...
                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item"><a href="../beranda/peserta.php">Home</a></li>
                                        ...
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title mb-4pt"
                                                   href="student_lesson.php">Pertemuan Pertama</a>
                                            </div>
                                            <a href="student_lesson.php"
                            ...
                            <div class="popoverContainer d-none">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-right">
                                        <a href="lesson_video/Pertemuan (1)/student_lesson.php"
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                                ...
                                <div class="mdk-reveal__content">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title mb-4pt"
                                                   href="student_lesson.php">Pertemuan Kedua</a>
                                            </div>
                                            <a href="student_lesson.php"
                                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                        </div>
                            ...
                            <div class="popoverContainer d-none">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-right">
                                        <a href="lesson_video/Pertemuan (2)/student_lesson.php"
                                           class="btn btn-primary">Lihat Video</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                                ...
                                <div class="mdk-reveal__content">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title mb-4pt"
                                                   href="student_lesson.php">Pertemuan Ketiga</a>
                                            </div>
                                            <a href="student_lesson.php"
                                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                        </div>
                            ...
                            <div class="popoverContainer d-none">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-right">
                                        <a href="lesson_video/Pertemuan (3)/student_lesson.php"
                                           class="btn btn-primary">Lihat Video</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                                ...
                                <div class="mdk-reveal__content">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title mb-4pt"
                                                   href="student_lesson.php">Pertemuan Keempat</a>
                                            </div>
                                            <a href="student_lesson.php"
                                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                        </div>
                            ...
                            <div class="popoverContainer d-none">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-right">
                                        <a href="lesson_video/Pertemuan (4)/student_lesson.php"
                                           class="btn btn-primary">Lihat Video</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                        ...
                        <div class="mdk-reveal__content">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex">
                                        <a class="card-title mb-4pt"
                                           href="student_lesson.php">Pertemuan Kelima</a>
                                    </div>
                                    <a href="student_lesson.php"
                                       class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                </div>
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="lesson_video/Pertemuan (5)/student_lesson.php"
                                   class="btn btn-primary">Lihat Video</a>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                        ...
                        <div class="mdk-reveal__content">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex">
                                        <a class="card-title mb-4pt"
                                           href="student_lesson.php">Pertemuan Keenam</a>
                                    </div>
                                    <a href="student_lesson.php"
                                       class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                </div>
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="lesson_video/Pertemuan (6)/student_lesson.php"
                                   class="btn btn-primary">Lihat Video</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                        ...
                        <div class="mdk-reveal__content">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex">
                                        <a class="card-title mb-4pt"
                                           href="student_lesson.php">Pertemuan Ketujuh</a>
                                    </div>
                                    <a href="student_lesson.php"
                                       class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                </div>
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="lesson_video/Pertemuan (7)/student_lesson.php"
                                   class="btn btn-primary">Lihat Video</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                        ...
                        <div class="mdk-reveal__content">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex">
                                        <a class="card-title mb-4pt"
                                           href="student_lesson.php">Pertemuan Kedelapan</a>
                                    </div>
                                    <a href="student_lesson.php"
                                       class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                                </div>
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="lesson_video/Pertemuan (8)/student_lesson.php"
                                   class="btn btn-primary">Lihat Video</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt"
                                   href="student_lesson.php">Pertemuan Kesembilan</a>
                            </div>
                            <a href="student_lesson.php"
                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                        </div>
            ...
            <div class="popoverContainer d-none">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <a href="lesson_video/Pertemuan (9)/student_lesson.php"
                           class="btn btn-primary">Lihat Video</a>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt"
                                   href="student_lesson.php">Pertemuan Kesepuluh</a>
                            </div>
                            <a href="student_lesson.php"
                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                        </div>
            ...
            <div class="popoverContainer d-none">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <a href="lesson_video/Pertemuan (10)/student_lesson.php"
                           class="btn btn-primary">Lihat Video</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt"
                                   href="student_lesson.php">Pertemuan Kesebelas</a>
                            </div>
                            <a href="student_lesson.php"
                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                        </div>
            ...
            <div class="popoverContainer d-none">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <a href="lesson_video/Pertemuan (11)/student_lesson.php"
                           class="btn btn-primary">Lihat Video</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt"
                                   href="student_lesson.php">Pertemuan Keduabelas</a>
                            </div>
                            <a href="student_lesson.php"
                               class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                        </div>
            ...
            <div class="popoverContainer d-none">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <a href="lesson_video/Pertemuan (12)/student_lesson.php"
                           class="btn btn-primary">Lihat Video</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3">
                    ...
                    <div class="mdk-reveal__content">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex">
                                    <a class="card-title mb-4pt"
                                    href="student_lesson.php">Pertemuan Ketigabelas</a>
                                </div>
                                <a href="student_lesson.php"
                                class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                            </div>
                ...
                <div class="popoverContainer d-none">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="lesson_video/Pertemuan (13)/student_lesson.php"
                            class="btn btn-primary">Lihat Video</a>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3">
                    ...
                    <div class="mdk-reveal__content">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex">
                                    <a class="card-title mb-4pt"
                                    href="student_lesson.php">Pertemuan Keempatbelas</a>
                                </div>
                                <a href="student_lesson.php"
                                class="ml-4pt material-icons text-20 card-course__icon-favorite">caret-right-square</a>
                            </div>
                ...
                <div class="popoverContainer d-none">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="lesson_video/Pertemuan (14)/student_lesson.php"
                            class="btn btn-primary">Lihat Video</a>
                        </div>
                    </div>
                </div>
