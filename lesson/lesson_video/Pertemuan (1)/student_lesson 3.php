                ...
                <div class="bg-primary pb-lg-64pt py-32pt">
                    <div class="container page__container">
                        ...
                        <div class="d-flex flex-wrap align-items-end mb-16pt">
                            <h1 class="text-white flex m-0">Menulis Kisah Memoar Inspiratif</h1>
                        </div>

                        <p class="hero__lead measure-hero-lead text-white mb-24pt">Silahkan Download Materi Dengan Mengklik Tombol Dibawah ini</p>
                        <a href="https://drive.google.com/file/d/1RenZ8KMoKGrJCbi-AzpJJDCozic_fwua/view?usp=sharing"><button type="button" class="btn btn-outline-warning">Download Materi 1</button></a>
