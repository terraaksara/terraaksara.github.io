                    ...
                    <div class="container page__container">
                        ...
                        <div class="js-player embed-responsive embed-responsive-16by9 mb-32pt">
                            <div class="player embed-responsive-item">
                                ...
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/DFJU5JpRk0s?start=10" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>

                        <div class="d-flex flex-wrap align-items-end mb-16pt">
                            <h1 class="text-white flex m-0">Mengatasi Kendala dan Hambatan Saat Menulis</h1>
                        </div>

                        <p class="hero__lead measure-hero-lead text-white mb-24pt">Silahkan Download Materi Dengan Mengklik Tombol Dibawah ini</p>
                        <a href="https://drive.google.com/file/d/1xZ6cqGDZHeatUOoP81-cjLOMQXisaHvh/view?usp=sharing"><button type="button" class="btn btn-outline-warning">Download Materi 1</button></a>
