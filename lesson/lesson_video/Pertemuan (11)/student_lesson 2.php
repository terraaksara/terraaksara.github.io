              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sidebar-menu-item" style="margin-top:13px;">
                      ...
                      href="student_lesson.php">
                          ...
                          <span class="sidebar-menu-text" style="line-height: 20px;">Komponen Buku</span>
                      </a>
                  </li>
                  ...
                  <li class="sidebar-menu-item" style="margin-top:13px;">
                      ...
                      href="student_lesson 1.php">
                          <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">home</span>
                          <span class="sidebar-menu-text" style="line-height: 20px;">Kiat-Kiat Agar Proses Menulis Buku Lancar dan Productif</span>
                      </a>
                  </li>
              </ul>
