                    ...
                    <div class="container page__container">
                        ...
                        <div class="js-player embed-responsive embed-responsive-16by9 mb-32pt">
                            <div class="player embed-responsive-item">
                                ...
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/Q0DH22jG6-I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="https://drive.google.com/file/d/1_fEm97qoP2e-LBOaLaKxG0Ui3sfiWDhb/view?usp=sharing"><button type="button" class="btn btn-outline-secondary">Download Materi 1</button></a>
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sidebar-menu-item" style="margin-top:13px;">
                      ...
                      href="student_lesson.php">
                          ...
                          <span class="sidebar-menu-text" style="line-height: 20px;">Kutipan</span>
                      </a>
                  </li>
                  ...
                  <li class="sidebar-menu-item active" style="margin-top:13px;">
                      ...
                      href="student_lesson 1.php">
                          <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">home</span>
                          <span class="sidebar-menu-text" style="line-height: 20px;">Plagirisme</span>
                      </a>
                  </li>
                  ...
                  <li class="sidebar-menu-item" style="margin-top:13px;">
                      ...
                      href="student_lesson 2.php">
                          <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">home</span>
                          <span class="sidebar-menu-text" style="line-height: 20px;">Daftar Pustaka</span>
                      </a>
                  </li>
              </ul>
